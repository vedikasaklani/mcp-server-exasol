...
CREATE TABLE IF NOT EXISTS DIM_TOOL (
    ...
    PARAMETER_SCHEMA VARCHAR(2000000),  -- JSON text, same convention as EVIDENCE elsewhere - Exasol has no JSON type
    DISCOVERY_SOURCE VARCHAR(20),        -- "declared" (SAST) | "observed" (live tools/list)
